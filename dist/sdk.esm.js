...
import IDenverPair from '@denverswap/core/build/IDenverPair.json';
...
var ZERO_HEX = '0x0';
/**
 * Represents the Apple Router, and has static methods for helping execute trades.
 */
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider) {
    try {
      ...
      return Promise.resolve(new Contract(address, IDenverPair.abi, provider).getReserves()).then(function (_ref) {
